...
ifdef UPDATECFG
$(shell echo "/*" > include/lightmodbus/libconf.h)
$(shell echo "	--This file gets automatically generated by makefile--" >> include/lightmodbus/libconf.h)
$(shell echo "" >> include/lightmodbus/libconf.h)
$(shell echo "	Its purpose is to configure each liblightmodbus header file, " >> include/lightmodbus/libconf.h)
$(shell echo "	so the user does not have to pass tons of compiler options each time " >> include/lightmodbus/libconf.h)
$(shell echo "	he/she wants to compile the library. " >> include/lightmodbus/libconf.h)
$(shell echo "	It also serves as a pretty nice source of information about current " >> include/lightmodbus/libconf.h)
$(shell echo "	library setup. " >> include/lightmodbus/libconf.h)
$(shell echo "" >> include/lightmodbus/libconf.h)
$(shell echo "	Do not edit this file manually unless you know what you are doing. " >> include/lightmodbus/libconf.h)
$(shell echo "*/" >> include/lightmodbus/libconf.h)
$(shell echo "#ifndef LIGHTMODBUS_LIBCONF_H " >> include/lightmodbus/libconf.h)
$(shell echo "#define LIGHTMODBUS_LIBCONF_H " >> include/lightmodbus/libconf.h)
$(shell echo " " >> include/lightmodbus/libconf.h)
include .makefile-staticmem
include .makefile-modules
$(shell echo "" >> include/lightmodbus/libconf.h)
$(shell echo "#endif" >> include/lightmodbus/libconf.h)
endif
