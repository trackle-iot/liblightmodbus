...
debug: modlib-base
debug: master-registers master-coils master-base master-discrete-inputs master-input-registers master-link
debug: slave-registers slave-coils slave-base slave-discrete-inputs slave-input-registers slave-link
