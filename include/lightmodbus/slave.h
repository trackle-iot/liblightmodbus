...
typedef struct modbusSlave
{
	...
	//Exact problem encountered during frame parsing
...
//Function prototypes
#ifdef LIGHTMODBUS_SLAVE_BASE
extern ModbusError modbusBuildException( ModbusSlave *status, uint8_t function, ModbusExceptionCode code ); //Build an exception
